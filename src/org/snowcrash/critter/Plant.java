/*  
 * Plant: A type of critter that does not move and feeds Prey. 
 ...
 * 
 * @author dearnest
 * A type of critter that does not move and feeds Prey.
...
public class Plant extends CritterBase {
	...
	public Plant(Critter critter1, Critter critter2) {
